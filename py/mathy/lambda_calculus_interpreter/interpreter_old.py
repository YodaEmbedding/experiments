...
exprs = [
    ...
    Lam(Var("x"), Var("x")),
    App(Lam(Var("z"), App(Lam(Var("x"), Var("x")), Var("y"))), Var("w")),
    Lam(Var("z"), App(Lam(Var("x"), Var("x")), Var("y"))),
    Lam(Var("y"), App(Lam(Var("x"), Var("x")), Var("y"))),
    App(Lam(Var("x"), App(Var("x"), Var("x"))), Lam(Var("y"), Var("y"))),
]
