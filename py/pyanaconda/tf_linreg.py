...
with tf.Session() as sess:
	...
	testing_cost = sess.run(cost_function, feed_dict={X: x_data_test_n, Y: y_data_test_n})
	...
	plt.plot(x_data_test_n, y_data_test_n, 'go', label='Normalized testing samples')
	plt.plot(x_data_n, sess.run(W) * x_data_n + sess.run(b), label='Fitted line')
	plt.legend()
