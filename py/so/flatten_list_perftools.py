...
def for_for(a): return [item for sublist in a for item in sublist]
def sum_brackets(a): return sum(a, [])
def functools_reduce(a): return functools.reduce(operator.iadd, a, [])
...
perfplot.show(
    ...
    kernels=[ for_for, sum_brackets, functools_reduce, itertools_chain,
        numpy_flat, numpy_concatenate ],
